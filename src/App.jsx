...
function App() {
  return (
    <div class="">
      <div class="bg-violet-600 px-4 py-3 text-white">
        <p class="text-center text-sm font-medium">
          Verselet UI 2023 Biggest Update!{" "}
          <a class="underline" href="/alpinejs">
            Learn More &rarr;{" "}
          </a>
        </p>
      </div>
      <div class="flex items-center justify-center h-screen w-full  overflow-hidden bg-gray-50 dark:bg-gray-800  ">
        <div class="px-6 py-8 md:px-8 w-1/4 bg-white rounded-lg shadow dark:bg-gray-800">
